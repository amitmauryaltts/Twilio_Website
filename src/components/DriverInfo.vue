  ...
  export default {
    ...
    methods: {
      ...
      disconnectVideoCall() {
        ...
        SaveUpdateDvrDetails.composeVideoRecordings(vm.roomSid, vm.participantSid, vm.fmsToken)
          .then((videoResponse) => {
            ...
            SaveUpdateDvrDetails.updateCalllogsFromDvrToOperator(vm.roomSid, vm.message, vm.videoResponse, vm.compositionSid, "completed")
              .then((response) => {
      ...
      saveNotes(callSid, message) {
        /* Api to update save logs  */
        SaveUpdateDvrDetails.updateCalllogsFromDvrToOperator(callSid, message, this.recordingUrl.url, this.recordingUrl.recordingSid, "completed")
          .then((response) => {
